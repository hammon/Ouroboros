...
public class SshUtils {
    ...
    private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(SshUtils.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ssh.connect("127.0.0.1","michael","uuiukzvl");
        ...
        try {
            String res = ssh.exec("hostname;sleep 7");
            log.info("RES: " + res);
        } catch (Exception e) {
            e.printStackTrace();
        }
   ...
   // private String host = "IR-P-Atlas-i-cd656529-a.private.mtlink.biz";
    ...
    public void connect(String hostName,String userName,String keyPath){
        ...
        if(!sshClient.isConnected()){
            log.log(Level.SEVERE,"Could not connect to " + hostName);
        }
    }
...
//    }
    ...
    public String exec(String command) {
        ...
        try {
            ...
            log.info("cmd result " + cmd.getExitStatus());
